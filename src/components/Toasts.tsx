...
export default function SuccessToast(props: ToastProps) {
    ...
    return (
        <div id="toast-success" className="fixed bottom-[77px] z-[10000] right-0 flex items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
            ...
            <div className="ml-3 text-center text-sm font-normal">{props.message}</div>
            <button
                onClick={() => {
...
export function ErrorToast(props: ToastProps) {
    ...
    return (
        <div id="toast-danger" className="fixed bottom-[77px] z-[10000] flex items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
